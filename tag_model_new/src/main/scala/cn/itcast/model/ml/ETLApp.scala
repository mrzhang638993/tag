...
import cn.itcast.model.data.PageViewsBeanCase
import cn.itcast.model.data.{ VisitBeanCase, WebLogBean, WeblogBeanCase}
...
object ETLApp {
  def main(args: Array[String]): Unit = {
     ...
     */
    //flume采集输出的路径
    val textRdd: RDD[String] = sc.textFile("hdfs://hadoop01:8020/flume/tailout/2021-01-26/events-.1611668088629")
